            ...
            if (response.ok) {
                ...
                document.querySelectorAll('.visualizar-usuario').forEach(button => {
                    button.addEventListener('click', function() {
                        ...
                        localStorage.setItem('userIdVisualizar', userId); // Armazena o ID do usuário
                        window.location.href = `visualizar.html?id=${userId}`; // Redireciona para a página de visualização com o ID
                    });
                });
